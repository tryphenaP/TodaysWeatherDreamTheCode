function initAutocomplete() {
    ...
    weatherLocationAutocomplete.addListener('place_changed', function () {
        ...
        /* Getting the latitute and longitude */
        var weatherLocationLatitude = place.geometry.location.lat();
        var weatherLocationLongitude = place.geometry.location.lng();
        var cityName = place.name; // Get the name for the title

        /* accessing open meteo API */
